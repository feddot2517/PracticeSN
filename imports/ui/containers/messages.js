...
class messages extends Component {
    ...
    render() {
        ...
        return (
            <div>
                <div style={{
                    padding: 25, marginLeft: 15, marginTop: 55, height: window.innerHeight, overflow: "auto"}}>

                <div className="dialogHead">Dialogs</div>
                {this.props.profile && this.props.profile.map((profile, id) => (
                    <div onClick={() => this.props.history.push(`/dialog/${profile.username}`)} className="dialog" key={id} >
                        ...
                        <div style={{ color:"grey", fontSize: 20, marginLeft: 10,}}>
